...
export default class Imagenes {
     ...
     */
    constructor(gl, initial_transform, imagen, active) {
        ...
        gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA, gl.RGBA, gl.UNSIGNED_BYTE, ImageLoader.getImage(imagen));
     ...
     */
    draw(gl, shader_locations, lightPos, viewMatrix, projectionMatrix, i) {
        //gl.useProgram(this.program);

        //gl.bindTexture(gl.TEXTURE_2D, this.texture);

        gl.uniform1i(shader_locations.u_texture, i);
    ...
    getVertices() {
        return [ //
            -5.625000, 1.250000, -0.000000, //
            5.625000, 1.250000, -0.000000, //
            -5.625000, 8.750000, 0.000000, //
            5.625000, 8.750000, 0.000000, //
        ]
    }

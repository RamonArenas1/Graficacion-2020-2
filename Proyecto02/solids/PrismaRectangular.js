...
export default class PrismaRectangular {
     ...
     */
    constructor(gl, width, height, length, initial_transform) {
        ...
        gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA, gl.RGBA, gl.UNSIGNED_BYTE, ImageLoader.getImage("./texturas/Prisma Rectangular.png"));

    ...
    getVertices() {
        ...
        for (let i = -1; i < this.Nv; i++) {
            for (let j = 0; j < this.Nu; j++) {
                ...
                pos.push(this.radius * Math.sin(j * 2 * Math.PI / this.Nu));
            }
        }
    ...
    getFaces() {
        ...
        for (let j = 0; j < this.Nv; j++) {
            for (let i = 0; i < this.Nu; i++) {
                ...
                faces.push(j + i * this.Nu); //4
                faces.push((j + 1) % this.Nu + (i + 1) * this.Nu); //1

                faces.push(j + i * this.Nu); //2
                faces.push(j + (i + 1) * this.Nu); //1
                faces.push((j + 1) % this.Nu + (i + 1) * this.Nu); //2

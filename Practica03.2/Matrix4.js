...
export default class Matrix3 {
     ...
     */
    multiplyVector(v) {
        return new CG.Vector4((v.x * this.a00) + (v.y * this.a10) + (v.z * this.a20) + (v.w * this.a30), (v.x * this.a01) + (v.y * this.a11) + (v.z * this.a21) + (v.w * this.a31), (v.x * this.a02) + (v.y * this.a12) + (v.z * this.a22) + (v.w * this.a32), (v.x * this.a03) + (v.y * this.a13) + (v.z * this.a23) + (v.w * this.a33));
    }
    ...
    static rotateZ(theta) {
        let g = Math.PI / 180;
        return new Matrix4(Math.cos(theta * g), Math.sin(theta * g) * (-1), 0, 0,
